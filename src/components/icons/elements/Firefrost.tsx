...
const SvgFirefrost = (props: SVGProps<SVGSVGElement>) => {
    const id = React.useId()
    return (
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" {...props}>
            <defs>
                <linearGradient id={`firefrost_svg__a_${id}`}>
                    <stop
                        offset={0}
                        style={{
                            stopColor: "#28fbff",
                ...
                <linearGradient
                    id={`firefrost_svg__b_${id}`}
                    x1={10.74}
                    x2={3.26}
                    y1={1.242}
                    y2={12.758}
                    gradientUnits="userSpaceOnUse"
                    href={`#firefrost_svg__a_${id}`}
                />
            </defs>
            <path
                ...
                style={{
                    fill: `url(#firefrost_svg__b_${id})`,
                    stroke: "none",
                    strokeWidth: 0.229848,
                }}
            />
        </svg>
    )
};
export default SvgFirefrost;
