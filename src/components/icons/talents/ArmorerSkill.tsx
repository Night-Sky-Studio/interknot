...
const SvgArmorerSkill = (props: SVGProps<SVGSVGElement>) => {
    ...
    return (
        ...
        >
            ...
            >
                <stop offset={0} stopColor="#fc341f" />
                <stop offset={1} stopColor="#fd829b" />
            </linearGradient>
            </defs>
            ...
            r={20}
            style={{
                fill: `url(#ArmorerSkill_svg__a_${id})`,
            }}
            />
...
export default SvgArmorerSkill;
